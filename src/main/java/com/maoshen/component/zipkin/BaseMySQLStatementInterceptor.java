...
public class BaseMySQLStatementInterceptor extends MySQLStatementInterceptor {
	...
	public ResultSetInternalMethods preProcess(final String sql, final Statement interceptedStatement,
		...
		ClientTracer clientTracer = BaseMySQLStatementInterceptor.clientTracer;
	...
	private void beginTrace(final ClientTracer tracer, final String sql, final Connection connection)
			throws SQLException {
		tracer.startNewSpan(UserRestContext.get().getLatestDaoName());
