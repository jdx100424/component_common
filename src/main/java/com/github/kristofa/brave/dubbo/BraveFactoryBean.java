...
import com.maoshen.component.zipkin.BaseHttpSpanCollector;
...
public class BraveFactoryBean implements FactoryBean<Brave> {
    ...
    private void createInstance() {
        ...
        if (this.zipkinHost != null && !"".equals(this.zipkinHost)) {
            builder.spanCollector(BaseHttpSpanCollector.create(this.zipkinHost, new EmptySpanCollectorMetricsHandler())).traceSampler(Sampler.create(rate)).build();
